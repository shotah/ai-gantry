...
const DefaultSparkPrompt = "" +
	"First: read [aims] in [harness]. If SELF.md has no north-star and there is no [aims] line, recall subject aim/bootstrap. Already asked and no answer → [silent]. Never asked → ONE months-scale question (what should we be aiming at for the next few months?). [wait]. Do not invent. memory_store fact subject aim/bootstrap that you asked.\n" +
