...
const RulesSection = "## Self-notes (`self_note` → SELF.md)\n\n" +
	...
	"- Empty board: no north-star in SELF.md and no [aims] line in [harness] → ask ONE months-scale question. Do not invent. After they answer: self_note + memory_store insight subject aim/<area>. Ask at most once per day (memory subject aim/bootstrap).\n" +
