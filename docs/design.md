...
| Self-notes | Agent-writable `SELF.md` (`self_note` + Voice graduate on trim + distill on `/new`); voice, rituals, standing aims; operator must audit/prune — [troubleshooting.md](troubleshooting.md#selfmd--personality-drift) |
