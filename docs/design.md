...
| Self-notes | Agent-writable `SELF.md` (`self_note` + Voice graduate on trim + distill on `/new`); operator must audit/prune if personality drifts — [troubleshooting.md](troubleshooting.md#selfmd--personality-drift) |
